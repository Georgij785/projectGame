...
положение камеры в игре будет сверху, и под углом, так же будет отличие от айзека, изза положения камеры можно будет видеть остальные комнаты уровня.
и так же можно реализовапть возможность объединения комнат при битве, взрывом или заклинанием например
